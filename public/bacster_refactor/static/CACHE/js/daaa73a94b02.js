...
app.controller('sessionController', ['$scope', 'Session', function($scope, Session) {
  ...
  // callback to start a new session
    $scope.startSession = function() {
	  ...
	  console.log('new session: ' + new_session.notes);
...
app.controller('sessionController_old', ['$scope', 'Session', '$state', 'session', 'workLog', function($scope, Session, $state, session, workLog) {
