...
app.factory('FormatJbrowse', ['$resource', function($resource) {
        return $resource('crud/jbrowse_links/:bacsession/:region', {"bacsession": "@bacsession", "region": "@region"}, {'query':  {method:'GET', isArray:false}});
}]);

app.factory('Bacitem', ['$resource', function($resource) {
        return $resource('crud/bacitems/:feature_id', {"feature_id": "@feature_id"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Coord_targets', ['$resource', function($resource) {
    return $resource('crud/tabix_results/:bacsession', {"bacsession": "@bacsession"}, {'query':  {method:'GET', isArray:true}});
}]);
...
app.factory('Bacsession', ['$resource', function($resource) {
        return $resource('crud/bacsessions', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('BacsessionBySessionID', ['$resource', function($resource) {
        return $resource('crud/bacsessions/:session', {"session": "@session"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Bac', ['$resource', function($resource) {
        return $resource('crud/bacs', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Targettype', ['$resource', function($resource) {
        return $resource('crud/target_types', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Target', ['$resource', function($resource) {
        return $resource('crud/targets', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}, 'remove': {method:'DELETE'}, 'delete': {method:'DELETE'} });
}]);

app.factory('Bacset', ['$resource', function($resource) {
        return $resource('crud/bacsets', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Genome', ['$resource', function($resource) {
        return $resource('crud/genomes', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);

app.factory('Organism', ['$resource', function($resource) {
        return $resource('crud/organisms', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});
}]);


app.factory('Session', ['$resource', function($resource) {
	return $resource('crud/sessions', {"pk": "@pk"}, {'query':  {method:'GET', isArray:true}});  
}]);
